  ...
  return (
    <aside className="surface-dark-hero hidden min-h-dvh flex-col p-4 lg:flex" aria-label="Learner workspace">
      ...
      <div className="mt-auto border-t border-white/15 pt-4">
        <p className="px-3 lms-meta text-fg-muted-dark">Learning portal v1 — your feedback shapes what comes next. <a className="font-bold text-green underline-offset-4 hover:underline" href="mailto:mailofelystai@gmail.com">Share an idea</a></p>
